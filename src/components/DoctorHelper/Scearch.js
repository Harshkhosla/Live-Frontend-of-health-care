    ...
    <div>
      ...
      {SearchdataImages?.map((data, index) => {
        ...
        <div className="d-flex flex-column m-3">
          ...
          <img alt="not fount" width={"300px"} height={"250px"} className="border border-dark" src={`https://nameless-bastion-00469.herokuapp.com/${data.image}}`} data-bs-toggle="modal" data-bs-target="#exampleModal" />
