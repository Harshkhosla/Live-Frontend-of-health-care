...
import { videoData8 } from '../../harsh reducers/action-creators'
import { SaveVideo8 } from '../../harsh reducers/action-creators'
import { deletVideo8 } from '../../harsh reducers/action-creators'
import { useDispatch, useSelector } from "react-redux";
const Video8 = () => {
    const dispatch = useDispatch();
    const imagesAllData = useSelector(state => state?.amount?.videoData8)
    ...
    const DeletNote = (id) => {
        ...
        //  debugger;
        dispatch(deletVideo8(imagesDataDeleting?.[0]))
        // debugger;
        // dispatch(imagesData())
    }
