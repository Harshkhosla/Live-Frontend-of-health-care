              ...
              <div className="col-md-4 d-flex flex-column my-2">
                <div class="card" style={{ backgroundColor: "#F1FAFE", width: "350px", height: "200px" }}>
                  ...
                  <div class="card-body">
                    ...
                    <h3 class="card-title">  {harsh?.name ?`Name : ${ harsh?.name }`: ""}</h3>
                    <p class="card-text ">{harsh?.title ? `Title :${ harsh?.title }` : ""}</p>
                    <p class="card-text"> {harsh?.discription ?`Description :${ harsh?.discription }` : ""}</p>
                    <p class="card-text"> {harsh?.contactNo ? `Contact Details : ${harsh?.contactNo}` : ""}</p>
                    <p class="card-text">{harsh?.email? `Email : ${harsh?.email}`:""}</p>
                    <p class="card-text"> {harsh?.setectDate ? `Date : ${harsh?.setectDate}`: ""}</p>
                    <p class="card-text">{harsh?.selectHour ? `Time : ${harsh?.selectHour}` : ""}</p>
                    <p class="card-text">{harsh?.numberofpeople ? `No. of Guests: ${harsh?.numberofpeople}` : ""}</p>
